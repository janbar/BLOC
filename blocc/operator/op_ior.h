...
class OpIORExpression : public Expression
{
...
public:
  ...
  virtual ~OpIORExpression();

  OpIORExpression(Expression * a, Expression * b, bool enc)
  ...
  {
    return Operator::OPVALS[Operator::OP_IOR];
  }
};
