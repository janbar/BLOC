...
class OpMODExpression : public Expression
{
...
public:
  ...
  virtual ~OpMODExpression();

  OpMODExpression(Expression * a, Expression * b, bool enc)
  ...
  {
    return Operator::OPVALS[Operator::OP_MOD];
  }
};
