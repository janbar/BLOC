...
class OpPOPExpression : public Expression
{
...
public:
  ...
  virtual ~OpPOPExpression();

  OpPOPExpression(Expression * a, Expression * b, bool enc)
  ...
  {
    return Operator::OPVALS[Operator::OP_POP];
  }
};
