...
class OpBANDExpression : public Expression
{
...
public:
  ...
  virtual ~OpBANDExpression();

  OpBANDExpression(Expression * a, Expression * b, bool enc)
  ...
  {
    return Operator::OPVALS[Operator::OP_BAND];
  }
};
