...
class OpBXORExpression : public Expression
{
...
public:
  ...
  virtual ~OpBXORExpression();

  OpBXORExpression(Expression * a, Expression * b, bool enc)
  ...
  {
    return Operator::OPVALS[Operator::OP_BXOR];
  }
};
