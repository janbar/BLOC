...
class OpANDExpression : public Expression
{
...
public:
  ...
  virtual ~OpANDExpression();

  OpANDExpression(Expression * a, Expression * b, bool enc)
  ...
  {
    return Operator::OPVALS[Operator::OP_AND];
  }
};
