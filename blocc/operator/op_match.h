...
class OpMATCHExpression : public Expression
{
...
public:
  ...
  virtual ~OpMATCHExpression();

  OpMATCHExpression(Expression * a, Expression * b, bool enc)
  ...
  {
    return Operator::OPVALS[Operator::OP_MATCH];
  }
};
