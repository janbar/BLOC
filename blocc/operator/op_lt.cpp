...
const Type& OpLTExpression::type(Context& ctx) const
{
...
Value& OpLTExpression::value(Context& ctx) const
{
...
std::string OpLTExpression::unparse(Context&ctx) const
{
  std::string str;
  if (arg2 == nullptr)
    str.append(Operator::OPVALS[Operator::OP_LT]).append(arg1->unparse(ctx));
  else
    str.append("(").append(arg1->unparse(ctx)).append(" ")
            .append(Operator::OPVALS[Operator::OP_LT]).append(" ")
