...
class OpEXPExpression : public Expression
{
...
public:
  ...
  virtual ~OpEXPExpression();

  OpEXPExpression(Expression * a, Expression * b, bool enc)
  ...
  {
    return Operator::OPVALS[Operator::OP_EXP];
  }
};
