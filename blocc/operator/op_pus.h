...
class OpPUSExpression : public Expression
{
...
public:
  ...
  virtual ~OpPUSExpression();

  OpPUSExpression(Expression * a, Expression * b, bool enc)
  ...
  {
    return Operator::OPVALS[Operator::OP_PUS];
  }
};
