...
#ifndef BUILTIN_MIN_H_
#define BUILTIN_MIN_H_
...
class MINExpression : public BuiltinExpression {
...
public:
  ...
  static MINExpression * parse(Parser& p, Context& ctx);
};

}

#endif /* BUILTIN_MIN_H_ */
