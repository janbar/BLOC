...
#ifndef BUILTIN_STR_H_
#define BUILTIN_STR_H_
...
class STRExpression : public BuiltinExpression {

public:

  virtual ~STRExpression() { }

  explicit STRExpression(std::vector<Expression*>&& args) : BuiltinExpression(FUNC_STR, std::move(args)) { }
  ...
  static STRExpression * parse(Parser& p, Context& ctx);
};

}

#endif /* BUILTIN_STR_H_ */
