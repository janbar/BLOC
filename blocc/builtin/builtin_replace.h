...
#ifndef BUILTIN_REPLACE_H_
#define BUILTIN_REPLACE_H_
...
class REPLACEExpression : public BuiltinExpression {
...
public:
  ...
  static REPLACEExpression * parse(Parser& p, Context& ctx);
};

}

#endif /* BUILTIN_REPLACE_H_ */
