...
#ifndef BUILTIN_RSUBSTR_H_
#define BUILTIN_RSUBSTR_H_
...
class RSUBSTRExpression : public BuiltinExpression {
...
public:
  ...
  static RSUBSTRExpression * parse(Parser& p, Context& ctx);
};

}

#endif /* BUILTIN_RSUBSTR_H_ */
